...
The schema here is the *runtime* source of truth. ``scripts/init_db.sql``
mirrors it for hosts that bootstrap Postgres outside the application
(e.g. via the ``ankane/pgvector`` image's docker-entrypoint-initdb.d).
"""
