-- ModelForge Database Initialization
-- Mirrors src/config/database.py:_SCHEMA_STATEMENTS so external bootstrap
-- (docker-entrypoint-initdb.d, manual psql, etc.) produces an identical
