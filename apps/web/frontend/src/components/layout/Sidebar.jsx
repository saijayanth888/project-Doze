  ...
  return (
    ...
    >
          ...
          return (
            <button
              ...
              style={{
                ...
                cursor: 'pointer', transition: 'background 150ms, border-color 150ms, color 150ms', outline: 'none',
              }}
            >
      ...
      <div style={{ padding: collapsed ? '10px 0' : '12px', borderTop: `1px solid ${C.border}`, display: 'flex', justifyContent: collapsed ? 'center' : 'stretch' }}>
        {collapsed ? (
          <button type="button" className="mf-cta-primary" onClick={() => navigate('/dashboard')} style={{ width: 36, height: 36, background: C.acc, border: 'none', borderRadius: 6, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: `0 0 16px ${C.accGlow}` }}>
